Diffusion Monte Carlo project used to solve the Schrodinger equation in 1D and 2D for the infinite potential wells. This uses random walks in the same method as the heat equation for classical physics.
